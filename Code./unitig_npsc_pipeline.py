...
for n in [100,50,30,10]:
    ...
    path="OutputNewNCV/OuterNoGroupRFECV/RFE_CORR/nselect"+str(n)+"/"
    ## Save AUC ##
...
## Further reduce number of features - Importance based -

for i in ["100","50","30","10"]:
    
    df = pd.read_csv("OutputNewNCV/OuterNoGroupRFECV/RFE_CORR/nselect"+str(i)+"/Fall/FeatureImportance.csv")
